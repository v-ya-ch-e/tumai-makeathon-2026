...
> Verbatim copy of [`Challenge Description Reply - The Campus Co-Pilot Suite.md`](https://github.com/DataReply/makeathon/blob/main/Challenge%20Description%20Reply%20-%20The%20Campus%20Co-Pilot%20Suite.md) from the official `DataReply/makeathon` repo. This is the authoritative challenge description — read this first.
...
- **Cloud services:** One AWS account per team pre-configured. Check out the resources under Kickstart & Examples to learn more about AWS services!
...
- **TUM systems:** We compiled a quick list of TUM web pages and services which your agent could interact with [here](https://github.com/DataReply/makeathon/blob/main/tum_systems.md) (also mirrored in [TUM_SYSTEMS.md](TUM_SYSTEMS.md)).
...
- **AWS Kickstart Slides:** [`Makeathon AWS Quickstart Guide.pdf`](https://github.com/DataReply/makeathon/blob/main/Makeathon%20AWS%20Quickstart%20Guide.pdf) — familiarizes you with the different AWS services you might use.
- **Example Repo:** [https://github.com/DataReply/makeathon](https://github.com/DataReply/makeathon)
  - Python (`.py` and notebook) examples for S3 (general storage) and Bedrock (LLMs). Includes a notebook that sets up a vector database from an HTML file using S3 Vectors and creates a LangGraph agent with access to it as a tool: [`RAG_agent_example.ipynb`](https://github.com/DataReply/makeathon/blob/main/python/notebooks/RAG_agent_example.ipynb).
  - TypeScript examples ([`typescript/README.md`](https://github.com/DataReply/makeathon/blob/main/typescript/README.md)): access S3, invoke Bedrock models, build a RAG with S3 Vectors, and create a LangChain pipeline with Bedrock.
- See [CODE_EXAMPLES.md](CODE_EXAMPLES.md) for an inlined index of the example repo.
...
This challenge is about much more than surviving the next semester at TUM. Next to genuinely helping students, think about the potential of similar tools outside of university life.
...
- [TUM_SYSTEMS.md](TUM_SYSTEMS.md) — APIs and scraping approaches for every TUM system mentioned above.
- [AWS_RESOURCES.md](AWS_RESOURCES.md) — Bedrock models, inference profiles, S3 / S3 Vectors, credentials, troubleshooting.
- [CODE_EXAMPLES.md](CODE_EXAMPLES.md) — copy-paste-ready Python + TypeScript snippets from the example repo.
- [CHALLENGE_OVERVIEW.md](CHALLENGE_OVERVIEW.md) — one-page orientation with Reply room/Discord/deadlines.
- [EVENT_LOGISTICS.md](EVENT_LOGISTICS.md) — full timetable, rooms, food.
